...
Útil para apresentar o portfólio com produtos, variações e categorias
...
# Cada produto: (nome, descrição_longa, categoria, subcategoria, [variações])
...
PRODUTOS = [
    ...
    (
        ...
        "Acessórios para Celular", "Películas",
        [
            ("Compatível 15", "9.80"),
    ...
    (
        ...
        "Acessórios para Celular", "Suportes",
        [("Único", "38.00")],
    ),
    (
    ...
    (
        ...
        "Carregamento & Energia", "Carregadores",
    ...
    (
        ...
        "Carregamento & Energia", "Power Banks",
    ...
    (
        ...
        "Smart Home", "Iluminação Inteligente",
    ...
    (
        ...
        "Smart Home", "Tomadas Inteligentes",
        [("10A", "55.00"), ("16A", "72.00")],
    ),
    (
...
PRODUTOS_SUPERMERCADO = [
    ...
    (
        ...
        "Frios & Laticínios", "Queijos & Frios",
    ...
    (
        ...
        "Frios & Laticínios", "Carnes & Congelados",
        [("700g", "14.20")],
    ),
    (
    ...
    (
        ...
        "Higiene & Beleza", "Cuidados Corporais",
        [("85g", "1.60")],
    ),
]
...
class Command(BaseCommand):
    help = "Popula o catálogo com produtos, variações e categorias de exemplo."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--limpar",
            action="store_true",
            help="Apaga o catálogo da empresa (produtos/variações/categorias) antes de popular.",
        )
    ...
    def handle(self, *args, **options):
        ...
        if options["limpar"]:
            ...
            self.stdout.write(self.style.WARNING(
                ...
                f"{sc[0]} subcategorias, {c[0]} categorias."
            ))
        ...
        for nome, descricao, cat_nome, sub_nome, variacoes in nicho["produtos"]:
